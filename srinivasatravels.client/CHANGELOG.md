...
- Create Angular project with ng: `ng new srinivasatravels.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`srinivasatravels.client.esproj`).
